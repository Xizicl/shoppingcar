...
<%@ page import="com.ct.pojo.*,com.ct.service.*" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<table border="0">
    ...
    %>
    <tr>
        <td style="width: 200px; max-width: 200px;"><%=book.getBookName()%>
        </td>
        <td class="wenzi-right, yuanjia" style="width: 150px;"><%=book.getBookPrice()%>
        </td>
        <td class="wenzi-right, total" style="width: 150px;"><%=book.getTotalMoney()%>
        </td>
        <td class="wenzi-right" style="width: 150px;"><input
                type="number" name="number" id="count"
                style="width: 50px; margin-right: 5px;"
                value="<%=entry.getValue()%>"/>
            <button type="button" onclick="add('<%=book.getBookID()%>')">确定</button>
        </td>
        <td class="wenzi-center" style="width: 50px;">
            <button
                    type="button">
